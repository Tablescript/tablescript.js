...
var grammar = {
    ...
    {"name": "MemberExpression", "symbols": ["MemberExpression", "_", {"literal":"["}, "_", "Expression", "_", {"literal":"]"}], "postprocess": ([target, , , , index]) => ({ type: 'member', target, index })},
    ...
    {"name": "IfExpression", "symbols": [(lexer.has("ifToken") ? {type: "ifToken"} : ifToken), "_", {"literal":"("}, "_", "Expression", "_", {"literal":")"}, "_", "Expression", "_", (lexer.has("elseToken") ? {type: "elseToken"} : elseToken), "_", "Expression"], "postprocess": ([ , , , , test, , , , ifExpression, , , , elseExpression]) => ({ type: 'if', test, ifExpression, elseExpression })},
    {"name": "IfExpression", "symbols": [(lexer.has("ifToken") ? {type: "ifToken"} : ifToken), "_", {"literal":"("}, "_", "Expression", "_", {"literal":")"}, "_", "Expression"], "postprocess": ([ , , , , test, , , , ifExpression]) => ({ type: 'if', test, ifExpression })},
    {"name": "WhileExpression", "symbols": [(lexer.has("whileToken") ? {type: "whileToken"} : whileToken), "_", {"literal":"("}, "_", "Expression", "_", {"literal":")"}, "_", "Expression"], "postprocess": ([ , , , , test, , , , loopBlock ]) => ({ type: 'while', test, loopBlock })},
    {"name": "UntilExpression", "symbols": [(lexer.has("untilToken") ? {type: "untilToken"} : untilToken), "_", {"literal":"("}, "_", "Expression", "_", {"literal":")"}, "_", "Expression"], "postprocess": ([ , , , , test, , , , loopBlock ]) => ({ type: 'until', test, loopBlock })},
    ...
    {"name": "TableEntry", "symbols": ["TableEntrySelector", "_", {"literal":":"}], "postprocess": ([selector, , , body]) => ({ type: 'tableEntry', selector, body })},
    {"name": "TableEntrySelector", "symbols": [(lexer.has("nonZeroDecimalInteger") ? {type: "nonZeroDecimalInteger"} : nonZeroDecimalInteger)], "postprocess": ([n]) => ({ type: 'tableEntrySelector', n })},
