...
var grammar = {
    ...
    {"name": "AssignmentExpression", "symbols": ["LeftHandSideExpression", "_", "AssignmentExpression$string$1", "_", "ConditionalExpression"]},
    {"name": "AssignmentExpression$string$2", "symbols": [{"literal":"-"}, {"literal":"="}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "AssignmentExpression", "symbols": ["LeftHandSideExpression", "_", "AssignmentExpression$string$2", "_", "ConditionalExpression"]},
    {"name": "AssignmentExpression$string$3", "symbols": [{"literal":"*"}, {"literal":"="}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "AssignmentExpression", "symbols": ["LeftHandSideExpression", "_", "AssignmentExpression$string$3", "_", "ConditionalExpression"]},
    {"name": "AssignmentExpression$string$4", "symbols": [{"literal":"/"}, {"literal":"="}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "AssignmentExpression", "symbols": ["LeftHandSideExpression", "_", "AssignmentExpression$string$4", "_", "ConditionalExpression"]},
    {"name": "AssignmentExpression$string$5", "symbols": [{"literal":"%"}, {"literal":"%"}, {"literal":"="}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "AssignmentExpression", "symbols": ["LeftHandSideExpression", "_", "AssignmentExpression$string$5", "_", "ConditionalExpression"]},
    ...
    {"name": "CallExpression$ebnf$1", "symbols": ["ArgumentList"], "postprocess": id},
    {"name": "CallExpression$ebnf$1", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "CallExpression", "symbols": ["CallExpression", "_", {"literal":"("}, "_", "CallExpression$ebnf$1", "_", {"literal":")"}]},
    {"name": "CallExpression", "symbols": ["MemberExpression"], "postprocess": id},
    {"name": "ArgumentList$ebnf$1", "symbols": []},
    {"name": "ArgumentList$ebnf$1$subexpression$1", "symbols": ["_", {"literal":","}, "_", "AssignmentExpression"]},
    ...
    {"name": "ArgumentList", "symbols": ["AssignmentExpression", "ArgumentList$ebnf$1"]},
