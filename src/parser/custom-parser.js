...
var grammar = {
    Lexer: lexer,
    ParserRules: [
    {"name": "Start", "symbols": ["_", "SingleExpression", "_"], "postprocess": ([ , e]) => ([e])},
    {"name": "Start", "symbols": ["_", "CompoundExpression", "_"], "postprocess": ([ , list]) => list},
    ...
    {"name": "CompoundExpression", "symbols": ["SingleExpression"]},
    {"name": "CompoundExpression", "symbols": ["CompoundExpression", "_", "SingleExpression"], "postprocess": ([list, , e]) => ([...list, e])},
    {"name": "SingleExpression", "symbols": ["AssignmentExpression", "_", {"literal":";"}], "postprocess": R.nth(0)},
    ...
    {"name": "FunctionBody", "symbols": [], "postprocess": () => { console.log('or here'); return []; }},
    {"name": "FunctionBody", "symbols": ["CompoundExpression"], "postprocess": (data) => { console.log('here!', data); return data; }},
